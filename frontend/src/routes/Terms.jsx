  ...
  return (
    <div className="terms">
      ...
      <div className="content">
        ...
        <p>
          By accessing or using MelodyMatch, you agree to be bound by these Terms of Service. If you
          do not agree to these terms, please do not use our service.
        </p>
        <h3>2. Eligibility</h3>
        <p>
          You must be at least 18 years old to use MelodyMatch. By using our service, you represent
          and warrant that you are at least 18 years of age and have the right, authority, and
          capacity to enter into these Terms.
        </p>
        <h3>3. Account Registration</h3>
        <p>
          To use certain features of MelodyMatch, you must register for an account. You agree to
        ...
        <p>
          You retain all rights to the content you post on MelodyMatch. By posting content, you
          grant MelodyMatch a non-exclusive, transferable, sub-licensable, royalty-free, worldwide
          license to use, copy, modify, create derivative works based on, distribute, publicly
          display, publicly perform, and otherwise exploit that content in connection with the
          service.
        </p>
        ...
        <p>
          In no event shall MelodyMatch, nor its directors, employees, partners, agents, suppliers,
        ...
        <h3>9. Contact Us</h3>
        <p>
          If you have any questions about these Terms, please contact us at legal@melodymatch.com.
        </p>
      </div>
    </div>
  );
